...
- `claude-infra docs/design/018-project-ssot-standard.md` **v0.6** — 본 리포 칸 구조(7+1 + ▸로드 선언·▸플랜)의 규격 · 참조 세대 = infra **develop `a406f24`**(그 SHA에서 `version: 0.6` 직독 · D-020 재가분)
- `claude-infra docs/design/019-project-migration-plan.md` **v0.7** — 018 적용 절차(T0~T7 · T5에 로드 선언·플랜 신설 편입) · 참조 세대 = infra **develop `a406f24`**(동상 · description v0.7 직독)
- `claude-infra docs/decisions/020-standard-amendment-load-declaration-and-plan.md` — 본 리포 두 파일 신설의 근거(소형 리포 최소 규격) · 참조 세대 = infra **develop `a406f24`**
